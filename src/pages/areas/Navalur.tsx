...
const NavalurPage = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Debris Removal Navalur Chennai | Site Clearance Services" 
        description="Professional debris removal in Navalur, Chennai. Reliable construction waste transport and demolition site clearance using Tata 407 trucks." 
        canonical="https://rajamanitransport.in/debris-removal-navalur"
        schema={{
          ...
          "itemListElement": [
            ...
            },
            {
              "@type": "ListItem",
              "position": 2,
              "name": "Navalur Debris Removal",
              "item": "https://rajamanitransport.in/debris-removal-navalur"
            }
          ]
        }}
      />
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              <h1 className="font-display font-bold text-4xl md:text-6xl text-foreground mb-6 text-balance">
                Debris Removal Services in Navalur
              </h1>
              <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
                Expert construction waste management and debris transport for residential and commercial projects in Navalur.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="prose prose-invert prose-lime max-w-none mb-16">
                <h2 className="text-3xl font-display font-bold text-primary">Trusted Debris Removal Chennai Navalur</h2>
                <p>
                  Navalur is one of the busiest commercial and residential hubs in Chennai, with constant construction and renovation activity. At Rajamani Transport, we specialize in <strong>debris removal Navalur</strong>, providing a seamless solution for builders and homeowners who need their sites cleared of rubble, masonry, and waste material.
                </p>
                <p>
                  Managing <strong>construction debris removal in Navalur</strong> requires a partner who understands the local landscape—from the narrow lanes of Dhandeeswaram to the main roads of Phoenix Market City area. Our Tata 407 fleet is perfectly sized to navigate these streets without causing traffic disruptions.
                </p>

                <h3 className="text-2xl mt-12 mb-4 font-display font-bold text-foreground">Our Site Clearance Process in Navalur</h3>
                <p>
                ...
                <h2 className="text-3xl font-display font-bold text-primary mt-16 mb-6">Demolition Waste Removal Navalur</h2>
                <p>
                  Navalur's urban density means that demolition projects must be handled with extreme care. Our <strong>demolition waste removal Navalur</strong> services are designed for safety and speed. We handle concrete blocks, bricks, steel scrap, and tile waste from old building demolitions.
                </p>
                <p>
                  Construction professionals in Navalur rely on Rajamani Transport because we offer fixed-rate pricing and 24/7 availability. We know that in a fast-paced construction environment, delays in debris removal can stall an entire project.
                </p>

                <div className="bg-card p-8 rounded-2xl border border-border/50 my-12 relative overflow-hidden">
                  <div className="relative z-10">
                    <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-primary"><Truck size={24} /> Tata 407: The Perfect Choice for Navalur</h3>
                    <p className="text-muted-foreground leading-relaxed">
                      Commercial trucks are often restricted in certain residential zones of Navalur during peak hours. However, the Tata 407's compact footprint allows us more flexibility, ensuring we can reach your site when you need us most.
                    </p>
                  </div>
                </div>

                <h2 className="text-3xl font-display font-bold text-primary mb-6">Serving All Parts of Navalur</h2>
                <p>
                  We provide comprehensive coverage across the entire Navalur suburb, including:
                </p>
                ...
                <p>
                  Don't let debris clutter your valuable space. For the most affordable <strong>debris removal Chennai Navalur</strong> price, call Rajamani Transport today. We offer quotes based on the number of loads or total volume, ensuring transparency in every job.
                </p>
              </div>

              <div className="bg-primary/10 border border-primary/20 p-10 rounded-3xl text-center">
                <h2 className="text-2xl font-display font-bold mb-4">Ready to Clear Your Navalur Site?</h2>
