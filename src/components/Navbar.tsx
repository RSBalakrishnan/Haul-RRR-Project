  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <a href="#home" className="flex items-center gap-3 md:gap-6 group">
          <img
            src={logo}
          ...
          <div className="flex items-center gap-2 md:gap-4">
            <div className="flex items-center gap-0.5 md:gap-1 select-none">
              ...
              <span
                ...
                style={{
                  background:
                    "linear-gradient(120deg,#b6ff00 0%,#ffffff 40%,#b6ff00 60%)",
              ...
              <div className="relative flex flex-col items-center">
                <span
                  ...
                  style={{
                    color: "#ff2d2d",
                    textShadow:
                      "0 0 6px rgba(255,50,50,0.7),0 0 14px rgba(255,50,50,0.4)",
                  }}
                >
                  R
                </span>
            ...
            <span className="text-[10px] md:text-xl tracking-[0.2em] md:tracking-[0.35em] font-semibold text-white select-none">
              TRANSPORT
            </span>
          </div>
        </a>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 rounded-lg font-semibold text-sm hover:shadow-[0_0_20px_5px_hsl(80_100%_50%/0.3)] transition-all duration-300"
          >
            <Phone size={16} />
            Call Now
          </a>
